...
urlpatterns = [
    ...
    path('poster/', views.seva_tiffin, name='seva-tiffin'),
    path('poster/', views.seva_pitara, name='seva-pitara'),
    path('poster/', views.seva_food, name='seva-food'),
    path('poster/', views.seva_news, name='seva-news'),
